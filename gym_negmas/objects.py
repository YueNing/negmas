...
class CarbotObj(WorldObj):
    """
    The bot car automatic running in the World
    """
...
class CarObj(WorldObj):
    """
    Cars arranged by Factories
    """
...
class FactoryObj(WorldObj):
    """
    All Factory type are inherit from FactoryObj
    """
    def __init__(self, obj, domain_rand, safety_radius_mult ):
        pass 
